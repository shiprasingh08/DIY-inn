...
import { CreditCard, ShoppingBag, Gift, ChevronRight, Heart } from 'lucide-react';
...
export default function CheckoutPage() {
  ...
  const cartItems = [
    ...
    { id: 2, name: 'Premium Acrylic Paint Set', price: 19.50, quantity: 2 },
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-6xl px-4 flex flex-col lg:flex-row gap-8">
        <div className="flex-1 bg-white rounded-2xl shadow-md p-6 lg:p-8">
          <div>
            ...
            <div className="mb-6">
              <h2 className="text-xl font-semibold mb-4 text-pink-800 flex items-center">
                <CreditCard className="mr-2" size={20} color="#be185d" />
                Payment Information
              </h2>
              <div className="mb-4">
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <div className="mt-2 flex">
                    ...
                    />
                    <button className="bg-pink-600 text-white px-4 rounded-r-lg hover:bg-pink-700 transition duration-300">
                      Apply
                    </button>
                  </div>
                </div>
