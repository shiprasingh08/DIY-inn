...
export default function OrderPlaced() {
  return (
    <Suspense fallback={<div className="h-screen w-full bg-gray-50 flex items-center justify-center"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-pink-500"></div></div>}>
      <OrderPlacedContent />
    </Suspense>
  );
}

// --- OrderPlacedContent.jsx ---

// Place this in a new file: OrderPlacedContent.jsx in the same folder
//
// "use client";
