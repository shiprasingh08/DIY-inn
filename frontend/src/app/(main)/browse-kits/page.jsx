              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                {filteredProducts.map((product) => (
                  ...
                  >
                    ...
                    <h2 className="text-lg font-semibold mb-2 text-center text-black">{product.title}</h2>
                    ...
                    <div className="flex flex-wrap gap-2 justify-center mb-2">
                      ...
                      <span className={`text-xs px-2 py-1 rounded ${product.stock > 5 ? 'bg-white text-green-600 border border-green-600' :
                    ...
                    <div className="flex gap-2 mt-auto w-full">
                      ...
                      {isInCart(product) ? (
                        ...
                        <button
                          ...
                          className={`flex-1 px-3 py-2 text-center text-sm rounded-lg ${product.stock <= 0
